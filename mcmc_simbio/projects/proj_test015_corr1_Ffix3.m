function [mi,mai, ri, tstamp, projdir, di]  = proj_test015_corr1_Ffix3(varargin)
% We fix the forward rates for all csp parameters, except the kfdg and
% krdg. I think CSP fixing might work here! 
%
% 
%
% Vipul Singhal,
...
mcmc_info = mcmc_info_test015_corr1_Ffix3(mobj, p.rkcp, p.cpol);
