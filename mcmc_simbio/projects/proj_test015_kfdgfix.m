function [mi,mai, ri, tstamp, projdir, di]  = proj_test015_kfdgfix(varargin)
% proj_acs_dsg2014
...
p.addParameter('temperatureLadder', [0.1]); % can be a boolean: true or false,
