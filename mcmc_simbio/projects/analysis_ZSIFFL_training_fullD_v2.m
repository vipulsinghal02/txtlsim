...
projdir = [pwd '\mcmc_simbio\projects\proj_ZSIFFL_trainingD_v2'];
addpath(projdir)
...
mcmc_info = mcmc_info_ZSIFFL_training_fullD_v2(mtet, mlac, mlas);
di = data_ZSIFFL;
...
switch tsIDtouse
    case 1 % this is after including the termination parameters.
        ...
        nIterID = {1:20 1:6 1:15}; % 1:15 1:4  1:8      
...
marray = cat(3, marray1, marray_full(:,:,1:end));
