...
projdir = [pwd '/mcmc_simbio/projects/proj_test015_corr1_Ffix3'];
addpath(projdir)
...
mcmc_info = mcmc_info_test015_corr1_Ffix3(mobj, exp(-2.8704), exp( 2.6442));
...
switch tsIDtouse
    case 1
        % this was done at the default ESP 2 params:
        %         ('rkcp', exp(-2.8704));
        %         ('cpol', exp( 2.6442));
        ts1 = '20190318_140222_1_208'; % 4000 steps per ts.
        ts2 = '20190318_140222_2_104';
        ts3 = '20190318_140222_3_21';
        ts4 = '20190318_140222_4_10';
        ts5 = '20190318_140222_5_2';
        ts6 = '20190319_074322_1_16';
        ...
        tsToSave = ts6;
        nIterID = {1:20, 1:20, 1:20 1:20 1:20 1:55};
    ...
    case 2
        % this was done with the second set of Esp 2 parameters.
        % 'rkcp', exp(-1.068),...
        % 'cpol', exp(1.33)
        ...
        ts1 = '20190318_150814_1_208';
        ts2 = '20190318_150814_2_104';
        ts3 = '20190318_150814_3_21';
        ts4 = '20190318_150814_4_10';
    ...
    case 2.1
        ...
        ts3 = '20190318_150814_3_21';
        ts4 = '20190318_150814_4_10';
        ts5 = '20190319_065336_1_21';
        
        tstamp = {ts1 ts2 ts3 ts4 ts5};
        tsToSave = ts5;
        nIterID = {1:20, 1:20, 1:20 1:20 1:40};
...
%
%
%% TRY TO PERFORM CORRECTION STEP 2
...
% clear non_empty
% clear ixs
% load('ESP2 points', 'ESP2_tilda') % does not work for the second set of points. 
...
% % 
%% I just try to perform correction step 2 with the actual parameter values 
% for ESP2 that were fixed in the corr step 1, and then the ESP1 values
% that look like they correspond from the calibration step:  -3.6 to -3.9 (-3.66) for kcp1 and 
       % 3.3 (+-0.2) (==3.26) for the pol1
% for the CSP, just pick indiscriminately from the estimated CSPs. Can also
% try to pick close to the kfdg and krdg csps that are constrained by the
% two ESP parameter sets (ESP1 and ESP2)
