function [mi,mai, ri, tstamp, projdir, di]  = proj_ZSIFFL_predictionCv3(varargin)
...
p.addParameter('stepSize', 1.1);
p.addParameter('nW', 40);
p.addParameter('nPoints', 40*30);
...
mcmc_info = mcmc_info_ZSIFFL_predictionCv3(mIFFL);
