...
% Finally, in the second half, repeat the analysis with the CSP fixed.

% In stage 3, if there is time, we can look at doing a similar thing, but with
% medians instead of arbitrary points.
...
% get the Parameter estimations from stage one, as those can be reused as
% the 'calibration step' here.
%
%
% run logs
...
runsimulation = false;
tstamp_corr_to_use_if_no_sim = '20180423_003333';
extrasavestr = '_stage2_case3_sharedCSP_pointnumber2';
% CASE1
...
specificprojdir = ['/Users/vipulsinghal/Dropbox/Documents/'...
    'toolbox/txtlsim_vsfork2017/'...
    'mcmc_simbio/projects/explore_corr_gfp3ii_w_and_wo_cov_stage2/simdata_' tstamp_corr];
...
mcmc_info_corr2 = mcmc_info_constgfp3v(mobj_corr1, cpol1, rkcp1);
